...
export const CUSTOM_ITEM_SIZES = [
  {
    id: 'small',
    label: 'Small',
    description: 'Fits in a shoebox (up to 5kg)',
    estimatedWeight: 5,
    basePrice: 15,
    icon: '📦',
  },
  {
    id: 'medium',
    label: 'Medium',
    description: 'Fits in a carry-on bag (5-15kg)',
    estimatedWeight: 15,
    basePrice: 30,
    icon: '📦📦',
  },
  {
    id: 'large',
    label: 'Large',
    description: 'Needs two hands to carry (15-30kg)',
    estimatedWeight: 30,
    basePrice: 50,
    icon: '📦📦📦',
  },
  {
    id: 'extra_large',
    label: 'Extra Large',
    description: 'Bulky items like TVs, furniture (30kg+)',
    estimatedWeight: 50,
    basePrice: 80,
    icon: '🏠',
  },
