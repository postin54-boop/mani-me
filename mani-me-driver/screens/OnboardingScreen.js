...
const slides = [
  {
    ...
    description: 'Join the Mani Me driver network. Pick up and deliver parcels across UK and Ghana.',
    icon: 'car',
    iconType: 'ionicon',
    accentColor: '#83C5FA',
  },
  {
    key: '2',
    title: 'Track & Earn',
    description: 'Monitor your earnings in real-time. Complete deliveries and watch your income grow.',
    icon: 'cash-multiple',
    iconType: 'material',
    accentColor: '#10B981',
  },
  {
    ...
    description: 'Get optimized routes and turn-by-turn directions to every pickup and delivery location.',
  ...
  },
  {
    ...
    description: 'Receive new assignments instantly. Accept jobs and start earning right away.',
    icon: 'bell-badge',
    iconType: 'material',
    accentColor: '#EC4899',
  },
...
export default function OnboardingScreen({ navigation }) {
  ...
  return (
    ...
    >
      ...
      {/* Driver Badge */}
      <View style={[styles.driverBadge, { top: insets.top + 16 }]}>
        <Ionicons name="car" size={16} color="#83C5FA" />
      ...
      <View style={[styles.bottomContainer, { paddingBottom: insets.bottom + 24 }]}>
        {currentIndex === slides.length - 1 ? (
          <TouchableOpacity 
            ...
            activeOpacity={0.8}
          >
            <Text style={styles.getStartedText}>Start Driving</Text>
